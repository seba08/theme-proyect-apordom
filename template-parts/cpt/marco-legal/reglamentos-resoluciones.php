<?php
    switch_to_blog(2);
        ...
        $args = array(
            'post_type' => 'marco-legal',
            'posts_per_page'=> -1,
            'tax_query' => array( 
                'relation' => 'OR',
                array(
                    'taxonomy' => 'marco_legal',
                    'field' => 'slug',
                    'terms' => array('reglamentos-resoluciones'),
                    'operator' => 'IN',
                ),
                ...
                array(
                    'taxonomy' => 'marco_legal',
                    'field' => 'slug',
                    'terms' => array('reglemento-resolucion'),
                    'operator' => 'IN',
                ),
                ...
                array(
                    'taxonomy' => 'marco_legal',
                    'field' => 'slug',
                    'terms' => array('reglamentos-y-resoluciones'),
                    'operator' => 'IN',
                ),
                array(
                    'taxonomy' => 'marco_legal',
                    'field' => 'slug',
                    'terms' => array('reglamento-y-resolucion'),
                    'operator' => 'IN',
                ),
                array(
                    'taxonomy' => 'marco_legal',
                    'field' => 'slug',
                    'terms' => array('reglamentos'),
                    'operator' => 'IN',
                ),
                array(
                    'taxonomy' => 'marco_legal',
                    'field' => 'slug',
                    'terms' => array('resoluciones'),
                    'operator' => 'IN',
                ),
                array(
                    'taxonomy' => 'marco_legal',
                    'field' => 'slug',
                    'terms' => array('reglamento'),
                    'operator' => 'IN',
                ),
                array(
                    'taxonomy' => 'marco_legal',
                    'field' => 'slug',
                    'terms' => array('resolucion'),
                    'operator' => 'IN',
                ),
            ),
            'meta_key' => 'orden',
