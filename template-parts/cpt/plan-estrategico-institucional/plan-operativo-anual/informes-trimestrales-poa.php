<?php
    switch_to_blog(2);
        ...
        $args = array(
            'post_type' => 'plan-estrategico',
            'posts_per_page'=> -1,
            'tax_query' => array( 
                'relation' => 'OR',
                array(
                    'taxonomy' => 'plan_estrategico',
                    'field' => 'slug',
                    'terms' => array('informes-trimestrales-poa'),
                    'operator' => 'IN',
                ),
                ...
                array(
                    'taxonomy' => 'plan_estrategico',
                    'field' => 'slug',
                    'terms' => array('informe-trimestral-poa'),
                    'operator' => 'IN',
                ),
                ...
                array(
                    'taxonomy' => 'plan_estrategico',
                    'field' => 'slug',
                    'terms' => array('informes-trimestrales'),
                    'operator' => 'IN',
                ),
                ...
                array(
                    'taxonomy' => 'plan_estrategico',
                    'field' => 'slug',
                    'terms' => array('informe-trimestral'),
                    'operator' => 'IN',
                ),
            ),
            'meta_key' => 'orden',
